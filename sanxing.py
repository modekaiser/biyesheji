...
qci = ChromiumPage()
qci.get('https://item.jd.com/100087971268.html')#https://item.jd.com/100146020217.html 三星Samsung Galaxy S25 Ultra https://item.jd.com/100087971268.html
...
for page in range(1, 101):
    print(f'正在采集Samsung第{page}页的数据内容')
    if page <= 2:
