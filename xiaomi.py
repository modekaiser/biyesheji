...
#小米17pro https://item.jd.com/100278751452.html 小米15 https://item.jd.com/100152201158.html
qci = ChromiumPage()
qci.get('https://item.jd.com/100152201158.html')
...
for page in range(1, 101):
    print(f'正在采集xiaomi第{page}页的数据内容')
    if page <= 2:
